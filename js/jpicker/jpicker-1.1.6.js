...
(function($, version)
{
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      color:
        {
          ...
          active: new Color({ ahex: '#ffffff' }), /* #ffcc00ff acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
      ...
      images:
        {
          clientPath: '/Minotz/js/jPicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
