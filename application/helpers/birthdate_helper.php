...
if (!function_exists('buildDayDropdown'))
{
    function buildDayDropdown($name='',$value='')
    {
        ...
        return form_dropdown($name, $day_list, $value,'class="form-control-day"');
    }
}	
...
if ( !function_exists('buildYearDropdown'))
{
    ...
    {        
        ...
        return form_dropdown($name, $year_list, $value,'class="form-control-year"');
    }
}
...
if (!function_exists('buildMonthDropdown'))
{
    function buildMonthDropdown($name='',$value='')
    {
        $month=array(
            ...
            '11'=>'November',
            '12'=>'December');
        return form_dropdown($name, $month, $value,'class="form-control-month"');
    }
}